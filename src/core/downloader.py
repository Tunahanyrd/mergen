...
import os, httpx, json, threading, time, re, sys, hashlib, traceback
...
class Downloader:
    ...
    """
    def __init__(self, url, save_dir=None, worker_count=None, progress_callback=None, status_callback=None, completion_callback=None, proxy_config=None):
        self.url = url
    ...
    def validate_segments(self):
        ...
        for seg in self.segments:
            ...
            if seg["finished"] and seg["downloaded"] < expected_size:
                self.log(f"Correction: Segment {seg['index']} marked invalid (Downloaded: {seg['downloaded']}, Expected: {expected_size}). Resetting.")
                seg["finished"] = False
